...
class MyRob(CRobLinkAngs):
    ...
    def wander(self):
        global direcao_atual,direita,esquerda,rotate_right,rotate_left,direcao_retaguarda,save,tras,antigo_tras,NodeID,Graph,path,go_to_path_step,direcao,go_to_path,LastvisitedNode,go_front,flagback,ground,arrayGPS_x,arrayGPS_y,direcaosave
    ...
    def driveInFront(self,values,final,x,y):
        ...
        # if values[6] == 1 and values[5] == 1 and values[4] == 1 and save[6] == 1 and save[5] == 1 and save[4] == 1 and final == (x,y): # FULL DIREITA
        if values[6] == 1 and save[6] == 1 and final == (x,y): # FULL DIREITA
            path = path[1:]
            go_to_path_step = 0   
            return 
        # if values[0] == 1 and values[1] == 1 and values[2] == 1 and save[0] == 1 and save[1] == 1 and save[2] == 1 and final == (x,y): # FULL ESQUERDA
        if values[0] == 1 and  save[0] == 1 and final == (x,y): # FULL ESQUERDA
            # print("ESQUERDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
            path = path[1:]
            # print("path:",path)
            # print("len[path]:",len(path))
            # LastvisitedNode = path[0]
            go_to_path_step = 0   
            # print("CHANGEEE TO START")
            return 
    ...
    def drive(self,values,x,y):
        ...
        if deadend == 1: #Resolve Beco-sem-saida
            ...
            if values[0] == 1 and values[1] == 1 and values[2] == 1 and save[0] == 1 and save[1] == 1 and save[2] == 1 and values[6] == 1 and values[5] == 1 and values[4] == 1:
                ...
                Graph.nodes[LastvisitedNode]['struct'][esquerda] = -1
                Graph.nodes[LastvisitedNode]['struct'][tras] = 2
                # print(Graph.nodes[LastvisitedNode]['struct'])
                antigo_tras = tras
                self.checkdirection(x,y)
    ...
    def checkdirection(self,x,y):
        ...
        if index == -1:
            print("ERROR")
            return -1
        # print(f"{index}-> {Graph.nodes[index]['struct']}")
