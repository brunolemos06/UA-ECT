...
sshpass -f ../password ssh -o StrictHostKeyChecking=no sd104@l040101-ws02.ua.pt 'cd Heist/dirControlCollectionSite ; java serverSide.main.ServerControlCollectionSite 22131 l040101-ws01.ua.pt 22130 l040101-ws04.ua.pt 22133 l040101-ws05.ua.pt 22134'
