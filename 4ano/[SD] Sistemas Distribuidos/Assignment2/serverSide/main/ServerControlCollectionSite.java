...
/**
 * Server side of ControlCollectionSite
 * 
    ...
    *        args[5] - name of the platform where is located the server for the assault party 2
     ...
     */
     ...
     public static void main(String [] args){
        ...
        ControlCollectionSite controlCollectionSite;                // concentration site
        ControlCollectionSiteInterface controlCollectionSiteInter;  // interface to the concentration site
        ...
        controlCollectionSite = new ControlCollectionSite(reposStub, partyStub);
        controlCollectionSiteInter = new ControlCollectionSiteInterface(controlCollectionSite);
        ...
        ControlCollectionSiteClientProxy cliProxy;
        waitConnection = true;
        ...
        scon.end();
        System.out.println("Server ControlCollectionSite was shutdown!");
