...
/**
 *  General Repository of Information (shared region)
...
public class GeneralRepo implements GeneralRepoInterface{
     ...
     */
    @Override
    public synchronized void finish(int totalcanvas) throws RemoteException{
        this.finish = false;
     ...
     */
    private void updateInfotemplate(FileWriter writer){
     ...
     */
    @Override
    public synchronized void updateInfo() throws RemoteException{
        if (this.finish){
            return;
        }
        try {
     ...
     */
    @Override
    public synchronized void setThiefsInAssault(int assaultID, int thiefID) throws RemoteException{
     ...
     * @param elemid tansformed thief id between 0 and 2
     * @param AssaultParty assault party id
     * @param thiefposition thief position
     */
    @Override
    public synchronized void changeposition(int elemid,int AssaultParty, int thiefposition) throws RemoteException{
        if(AssaultParty == 0){
     ...
     */
    @Override
    public synchronized void settargetRoom(int assID,int targetRoom) throws RemoteException{
        boolean flag = false;
        if(assID == 0){
     ...
     * @param thiefID thief id
     * @param hasacanvas 1 if has a canvas, 0 if not
     * @param roomid room id
     * @param assID assault party id
     */
    @Override
    public synchronized void changehasacanvas(int thiefID,int hasacanvas,int roomid,int assID) throws RemoteException{
        int index = 0;
     ...
     */
    @Override
    public synchronized void thiefStateW(int thiefid) throws RemoteException{
    ...
    /**
     * Change the state of the thief to P [On Assault Party]
     * @param thiefid thief id
     */
    @Override
    public synchronized void thiefStateP(int thiefid) throws RemoteException{
     ...
     */
    @Override
    public synchronized void putMasterState(int state) throws RemoteException{
     ...
     */
    @Override
    public synchronized void putThiefState(int state, int thiefid) throws RemoteException{
        boolean printnow = true;
     ...
     * @param agility array of ints with the agility of the thieves, size M-1
     */
    @Override
    public synchronized void setAgility(int[] agility) throws RemoteException{
        thievesAgility = agility;
    }

    /**
     * Keeps the distance of the rooms
     * @param distance array of ints with the distance of the rooms, size N
     */
    @Override
    public synchronized void setRoomsDistance(int[] distance) throws RemoteException{
        roomaxdist = distance;
    }

    /**
     * Keeps the number of paintings in each room
     * @param paintings array of ints with the number of paintings in each room, size N
     */
    @Override
    public synchronized void setPaintings(int[] paintings) throws RemoteException{
