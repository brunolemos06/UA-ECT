...
public class ConcentrationSite{
  ...
  */
  ...
  /**
  * Room ID of the target room of the assembling group
  */ 
  ...
  */
  ...
  /**
  * The thieves join the assault party 
  ...
  */
  public synchronized int prepareExcursion() {
    ...
    //set the target room on the thief
    ((NormalThief) (Thread.currentThread())).setTargetRoomID(currentRoomID);
    //set the assault party on the thief
    ((NormalThief) (Thread.currentThread())).setAssaultPartyID(currentAssaultPartyID);
  ...
  * @return character that indicates the thief is needed
  */
