...
// A: Sim, porque depois de destruir a subarvore (porque o estamos a fazer de baixo para cima) 
// é que destrói o nó e, portanto, não precisa mais de referência-lo utilizando variáveis auxiliares.
...
// A: Sim, não em termos de complexidade mas sim de maneira a devolver, 
// na função utilizada pelo cliente (BSTreeGetItems), 
// a fila com os itens da árvore ordenados.
