...
public interface StrLangListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterStatDecl(StrLangParser.StatDeclContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StatDecl}
	 * labeled alternative in {@link StrLangParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatDecl(StrLangParser.StatDeclContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link StrLangParser#decl}.
	 * @param ctx the parse tree
	 */
	void enterDecl(StrLangParser.DeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link StrLangParser#decl}.
	 * @param ctx the parse tree
	 */
	void exitDecl(StrLangParser.DeclContext ctx);
	/**
