...
public interface FracLangVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExprPositiveNegative(FracLangParser.ExprPositiveNegativeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FracLangParser#decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecl(FracLangParser.DeclContext ctx);
}